...
<div class="bg-white shadow-lg border-1 border-yellow-500 rounded-xl overflow-hidden hover:shadow-2xl transition">
    <div class="mb-4">
    ...
    <div class="p-4">
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('listings.show', $listing->id) }}"
                class="bg-red-600 hover:bg-red-700 transition text-white px-4 py-2 rounded-md font-semibold">
                Details
            </a>
