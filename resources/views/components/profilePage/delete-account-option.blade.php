<button class="btn text-md bg-red-900 text-white hover:bg-red-700 transition mb-2" onclick="my_modal_3.showModal()">
    Delete Account
</button>
    ...
    <div class="modal-box">
        ...
        <form method="POST" action="{{ route('profile.destroy') }}">
            ...
            <div class="flex items-center justify-between pt-4">
                ...
                <button type="submit"
                    class="bg-red-600 text-white text-sm px-4 py-2 cursor-pointer rounded-md hover:bg-red-700 font-semibold transition">
                    Delete Account
                </button>
            </div>
        </form>
